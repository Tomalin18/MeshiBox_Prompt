...
### 2024-12-19 - OCR讀音保存修復與羅馬字統一
- ✅ 修復CardEditScreen保存時遺漏nameReading和companyReading欄位
- ✅ 改善自動讀音生成邏輯，不覆蓋OCR掃描的讀音
- ✅ 添加完整的平假名轉羅馬字轉換功能
- ✅ 統一要求使用羅馬字格式（例：Go Masatoshi）
- ✅ 解決OCR掃描讀音丟失問題
- ✅ 更新編輯頁面說明文字和用戶指導
...
### 10. [自動讀音生成功能](./12-automatic-reading-generation.md)
- **修復日期**: 2024-12-19
- **問題**: 現有名片缺少讀音數據，如「橋本正史」等
- **解決**: 實現自動讀音生成，支援複合姓名分析
- **狀態**: ✅ 完成

### 11. [OCR讀音保存修復與羅馬字統一](./13-ocr-reading-preservation-and-romaji-unification.md)
- **修復日期**: 2024-12-19
- **問題**: OCR掃描的讀音保存後消失，格式不統一
- **解決**: 修復保存邏輯，統一使用羅馬字格式
- **狀態**: ✅ 完成
